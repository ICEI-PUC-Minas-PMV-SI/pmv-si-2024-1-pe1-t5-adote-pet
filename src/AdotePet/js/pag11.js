...
window.onload = function() {
  ...
  // Populate the form fields from localStorage on page load
  var name = localStorage.getItem('name');
  var foundationdate = localStorage.getItem('foundationdate');
  var contactnumber = localStorage.getItem('contactnumber');
  var email = localStorage.getItem('email');
  var password = localStorage.getItem('password');

  if (name) form.elements['name'].value = name;
  if (foundationdate) form.elements['foundationdate'].value = foundationdate;
  if (contactnumber) form.elements['contactnumber'].value = contactnumber;
  ...
  form.addEventListener('submit', function(event) {
    ...
    var foundationdate = form.elements['foundationdate'].value;
    var contactnumber = form.elements['contactnumber'].value;
    var email = form.elements['email'].value;
    var password = form.elements['password'].value;

    // Store these values in localStorage
    localStorage.setItem('name', name);
    localStorage.setItem('foundationdate', foundationdate);
  ...
  document.getElementById('file-upload').addEventListener('change', function(e) {
    ...
    reader.onload = function(event) {
        document.querySelector('.image-3').src = event.target.result;
    }
  ...
  // When the page loads, check if there's an image in localStorage
  window.addEventListener('load', function() {
      var savedImage = localStorage.getItem('uploadedImage');
      if (savedImage) {
          // If there is, display the image
          document.querySelector('.image-3').src = savedImage;
          document.querySelector('.image-6').src = savedImage;
      }
  });
}
      ...
      var f = (d.frame = (function () {
              ...
              (ke = P[re]),
                re in ae
                  ? (ve.transform || (ve.transform = {}),
                    (ve.transform[re] = ke))
                  : (D.test(re) && (re = p(re)),
                    re in k ? (ve[re] = ke) : (ye || (ye = {}), (ye[re] = ke)));
            for (re in ve) {
        ...
        h = G(function (e) {
          ...
          function a(u) {
            ...
            return (R ? K(R[1], R[2], R[3]) : u).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3",
            );
          }
          ...
          (e.init = function (u, R, H, se) {
            ...
            H[2] && (w = H[2]),
              ...
              (this.name = w),
              (this.type = H[1]),
              (this.duration = I(R[1], this.duration, o.duration)),
              (this.ease = s(R[2], this.ease, o.ease)),
              (this.delay = I(R[3], this.delay, o.delay)),
          ...
          (e.init = function () {
            ...
            (e.values = function (a) {
              var o,
                u = {};
              return (
                s.call(this, a, function (R, H, se) {
                  (u[R] = H),
                    this.current[R] === void 0 &&
                      ((o = 0),
                      ~R.indexOf("scale") && (o = 1),
                      (this.current[R] = this.convert(o, se)));
                }),
                u
              );
            });
        ...
        c = G(function (e) {
          ...
          var R = { ease: J.ease[1], from: 0, to: 1 };
          (e.init = function (w) {
            (this.duration = w.duration || 0), (this.delay = w.delay || 0);
            var X = w.ease || R.ease;
            J[X] && (X = J[X][1]),
              typeof X != "function" && (X = R.ease),
              (this.ease = X),
          ...
          (e.init = function (s) {
            ...
            (e.render = function (s) {
              ...
              for (a = u; a--; )
                (o = this.tweens[a]),
                  o.context &&
                    (o.render(s), (this.current[o.name] = o.value), (R = !0));
              return R
        ...
        (t.debounce = function (l, v, L) {
          var _,
            ...
            A = function () {
              ...
              g < v
                ? (_ = setTimeout(A, v - g))
                : ((_ = null), L || ((O = l.apply(N, q)), (N = q = null)));
            };
          return function () {
...
` +
        ...
        function t(p) {
          ...
          function I(E) {
            var $ = E.type,
              z = E.tagName;
            return !!(
              (z === "INPUT" && W[$] && !E.readOnly) ||
              (z === "TEXTAREA" && !E.readOnly) ||
              E.isContentEditable
            );
          }
          function Z(E) {
          ...
          function G(E) {
            E.metaKey ||
              E.altKey ||
              E.ctrlKey ||
              (M(p.activeElement) && Z(p.activeElement), (S = !0));
          }
          function J() {
            S = !1;
          }
      ...
      (Et.exports = function (t, d) {
        ...
        function ee(U) {
          if (!U.getAttribute("hreflang")) {
            var D =
              (K && U.getAttribute("href-disabled")) || U.getAttribute("href");
            if (((M.href = D), !(D.indexOf(":") >= 0))) {
              ...
              if (
                ...
                var $ = t(M.hash);
                $.length && G.push({ link: E, sec: $, active: !1 });
                return;
              }
              if (!(D === "#" || D === "")) {
                var z =
  ...
  var _t = be((pn, kt) => {
    ...
    $e.define(
      ...
      (kt.exports = function (t) {
        ...
        function E(y, l) {
          ...
          switch (l) {
            case "add":
              (v = y.attr("tabindex")),
                v
                  ? y.attr("data-wf-tabindex-swap", v)
                  : y.attr("tabindex", "-1");
              break;
            case "remove":
              (v = y.attr("data-wf-tabindex-swap")),
                v
                  ? (y.attr("tabindex", v),
        ...
        function Y(y, l) {
          ...
          if (v !== L) {
            var _ = fe(y, v, L),
              ...
              N = function () {
                var f = Date.now() - q;
                window.scroll(0, pe(v, L, f, _)),
                  f <= _ ? M(N) : typeof l == "function" && l();
              };
            M(N);
          }
        }
        ...
        function he() {
          var { WF_CLICK_EMPTY: y, WF_CLICK_SCROLL: l } = d;
          T.on(l, G, $),
            T.on(y, oe, function (v) {
              v.preventDefault();
            }),
    ...
    Jt.define(
      ...
      (Ot.exports = function (t) {
        ...
        (t.event.special.tap = { bindType: "click", delegateType: "click" }),
          (d.init = function (T) {
            return (
              (T = typeof T == "string" ? t(T).get(0) : T), T ? new S(T) : null
            );
          });
        function S(T) {
          var W = !1,
          ...
          function G(Q) {
            ...
            (U && U.length > 1) ||
              ((W = !0),
              U ? ((M = !0), (Z = U[0].clientX)) : (Z = Q.clientX),
              (oe = Z));
          }
          function J(Q) {
            if (W) {
              ...
              (oe = D),
                Math.abs(E) > I &&
                  p &&
                  String(p()) === "" &&
                  (K("swipe", Q, { direction: E > 0 ? "right" : "left" }),
                  ee());
            }
          }
          function F(Q) {
  ...
  var Ct = be((gn, Tt) => {
    ...
    var Je = window.jQuery,
      ...
      Xe = {
        ...
        intro: function (t, d) {
          d.__wf_intro ||
            ((d.__wf_intro = !0), Je(d).triggerHandler(Re.types.INTRO));
        },
        outro: function (t, d) {
          d.__wf_intro &&
            ((d.__wf_intro = null), Je(d).triggerHandler(Re.types.OUTRO));
        },
      };
    Re.triggers = {};
    Re.types = { INTRO: "w-ix-intro" + Lt, OUTRO: "w-ix-outro" + Lt };
    Re.init = function () {
  ...
  var tt = be((wn, It) => {
    ...
    Ve.triggers = {};
    Ve.types = { INTRO: "w-ix-intro" + St, OUTRO: "w-ix-outro" + St };
  ...
  var Ft = be((bn, Dt) => {
    ...
    Pe.define(
      ...
      (Dt.exports = function (t, d) {
          ...
          B || (B = "w-dropdown-toggle-" + r),
            ...
            c.links.each(function (n, m) {
              m.hasAttribute("tabindex") || m.setAttribute("tabindex", "0"),
                rn.test(m.hash) && m.addEventListener("click", y.bind(null, c));
            }),
            c.el.off(I),
            c.toggle.off(I),
            c.nav && c.nav.off(I);
        ...
        function pe(r) {
          return function (b, x) {
            (x = x || {}),
              fe(r),
              x.open === !0 && he(r, !0),
              x.open === !1 && y(r, { immediate: !0 });
          };
        }
        function Ee(r, b) {
          return p(function (x) {
            if (r.open || (x && x.type === "w-close"))
              return y(r, { forceClose: b });
            he(r);
          });
        }
        function he(r) {
        ...
        function L(r) {
          return (
            r.mouseUpOutside && $.off(U, r.mouseUpOutside),
            p(function (b) {
              if (r.open) {
                var x = t(b.target);
        ...
        function h(r) {
          return p(function (b) {
            var { relatedTarget: x, target: c } = b,
              B = r.el[0],
              le = B.contains(x) || B.contains(c);
        ...
        function $() {
          ...
          S.on(
            ...
            S.on("change", M + ' form input[type="radio"]', (x) => {
              t(`input[name="${x.target.name}"]:not(${f})`).map((B, le) =>
                t(le).siblings(O).removeClass(A),
              );
              let c = t(x.target);
      ...
      (Wt.exports = function (t, d) {
        ...
        function pe(n, m) {
          ...
          ae &&
            ...
            l(k),
            Z
              ? (he(k), k.el.on("setting" + F, v(k)))
              : (y(k),
                k.button.on("click" + F, f(k)),
                k.menu.on("click" + F, "a", O(k)),
                k.button.on("keydown" + F, L(k)),
                k.el.on("keydown" + F, _(k))),
            h(n, m);
        }
        function Ee(n, m) {
          var C = t.data(m, F);
        ...
        function l(n) {
          ...
          (m.animOver = /^over/.test(k)),
            ...
            C.animation !== k && n.open && d.defer(N, n),
        ...
        function B(n, m) {
          ...
          if (
            ...
            S(n.menu)
              .add(s)
              .set({ x: C.animDirect * Se, height: ae })
              .start({ x: 0 })
              .then(o),
          ...
          var a = e + De;
          S(n.menu).add(s).set({ y: -a }).start({ y: 0 }).then(o);
          function o() {
        ...
        function V(n, m) {
          ...
          var e = Se + ae;
          S(n.menu).add(k).start({ y: -e }).then(i);
          function i() {
            n.menu.height(""),
